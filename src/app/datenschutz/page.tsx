...
const DICT: Record<Locale, Dict> = {
  de: {
    ...
    s3Body: "laconis setzt nur funktionale Cookies ein, die für den reibungslosen Betrieb der Website notwendig sind (z. B. zur Speicherung deiner Akzentfarben-Einstellung im LocalStorage). Es findet kein Tracking oder Profiling statt.",
  ...
  fr: {
    ...
    s3Body: "laconis n'utilise que des cookies fonctionnels nécessaires au bon fonctionnement du site (ex. : stockage de ta préférence de couleur d'accent dans LocalStorage). Aucun tracking, aucun profilage.",
  ...
  en: {
    ...
    s3Body: "laconis uses only functional cookies needed for smooth operation (e.g. to store your accent colour preference in LocalStorage). No tracking, no profiling.",
    s4Title: "processors",
