...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const statisch: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/leistungen/grafik`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE}/leistungen/grafik/simulator`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
