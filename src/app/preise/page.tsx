...
const DICT: Record<Locale, Dict> = {
  de: {
    ...
    faq: [
      { frage: "wie geht's nach dem anfragen los?", antwort: "Ich melde mich, sobald ich mir das angeschaut habe. Dann: 20–30 min Gespräch · was du brauchst, was realistisch ist, wo der einstieg liegt. Danach bekommst du ein konkretes Angebot, schriftlich und ohne Kleingedrucktes." },
    ...
    ctaHeadlinePre: "ich sag dir ehrlich, ",
  ...
  fr: {
    ...
    faq: [
      { frage: "comment ça se passe après la demande ?", antwort: "Je reviens vers toi dès que j'ai regardé. Ensuite : 20–30 min d'échange · ce dont tu as besoin, ce qui est réaliste, où on commence. Puis tu reçois une offre concrète, par écrit et sans petits caractères." },
    ...
    ctaHeadlinePre: "je te dis franchement, ",
  ...
  en: {
    ...
    faq: [
      { frage: "what happens after the inquiry?", antwort: "I get back to you once I've had a look. Then: 20–30 min talk · what you need, what's realistic, where we start. After that you get a concrete written offer, no small print." },
    ...
    ctaHeadlinePre: "i'll tell you straight, ",
