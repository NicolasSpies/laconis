...
const SERVICES: Record<Locale, { name: string; description: string; serviceType: string }[]> = {
  de: [
    { name: "Website von null gebaut", description: "Design und Code entstehen für dich · kein Theme, kein Baukasten. Responsiv, SEO-fertig, eigenes Analytics, SSL und Backups. Domain und Mail separat.", serviceType: "Web Development" },
  ...
  fr: [
    { name: "Site web construit de zéro", description: "Design et code faits pour toi · pas de thème, pas de constructeur. Responsive, prêt pour le SEO, analytics maison, SSL et sauvegardes. Domaine et mail à part.", serviceType: "Web Development" },
  ...
  en: [
    { name: "Website built from scratch", description: "Design and code made for you · no theme, no builder. Responsive, SEO-ready, own analytics, SSL and backups. Domain and mail separate.", serviceType: "Web Development" },
