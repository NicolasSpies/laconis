...
/**
 * AnsatzToggle — zeigt manifest-variante für web oder grafik.
...
export function AnsatzToggle({
  ...
  return (
    <>
        ...
        <div className="container-site">
          <div className="max-w-[760px]">
            ...
            <p className="mt-6 max-w-[560px] text-[15px] leading-relaxed text-offwhite/55">
              die no-gos unterscheiden sich zwischen web und grafik ·
      ...
      <div className={cn(mode === "grafik" ? "block" : "hidden")}>
        {grafik}
      </div>
    </>
  );
