...
const DICT: Record<Locale, Dict> = {
  de: {
    ...
    thanksBody1: "Deine Anfrage ist da · Antwort kommt per ",
    ...
    step3Footer: "Wenn alles stimmt, nächster Schritt: deine Kontaktdaten + optional eine Notiz. Angebot kommt schriftlich.",
    step3Edit: "ändern",
    step3BudgetOpen: "· noch offen",
    step4H3: "wer bist du?",
    step4Body: "Nur das Nötigste. Telefon und Notiz sind freiwillig. Ich antworte per Mail.",
    fieldName: "name",
    fieldEmail: "e-mail",
  ...
  fr: {
    ...
    thanksBody1: "Ta demande est là · réponse par ",
    ...
    step3Footer: "Si tout colle, prochaine étape : tes coordonnées + une note optionnelle. Offre par écrit.",
    step3Edit: "modifier",
    step3BudgetOpen: "· encore ouvert",
    step4H3: "tu es qui ?",
    step4Body: "Que l'essentiel. Téléphone et note sont facultatifs. Je réponds par mail.",
    fieldName: "nom",
    fieldEmail: "e-mail",
  ...
  en: {
    ...
    thanksBody1: "Your request is in · answer by ",
    ...
    step3Footer: "If it all checks out, next step: your contact details + optional note. Offer in writing.",
    step3Edit: "edit",
    step3BudgetOpen: "· still open",
    step4H3: "who are you?",
    step4Body: "Just the essentials. Phone and note are optional. I reply by mail.",
    fieldName: "name",
    fieldEmail: "e-mail",
